...
TEST(asof_join_partitioning_right_filter_min, TestSmallDuckDBExample) {
    Prices prices = load_prices("../test/data/prices_small.csv", ',', true);
    OrderBook order_book = load_order_book("../test/data/orderbook_small.csv", ',', true);
...
TEST(asof_join_partitioning_right_filter_min, TestSmallBTCExample) {
    Prices prices = load_prices("../test/data/btc_usd_data.csv", ',', true);
    OrderBook order_book = load_order_book("../test/data/btc_orderbook_small.csv", ',', true);
    PartitioningRightFilterMinASOFJoin join(prices, order_book, LESS_EQUAL_THAN, INNER);
...
TEST(asof_join_partitioning_right_filter_min, TestSmallUniformExample) {
    Prices prices = load_prices("../test/data/uniform_small_prices.csv", ',', true);
    OrderBook order_book = load_order_book("../test/data/uniform_small_positions.csv", ',', true);
    PartitioningRightFilterMinASOFJoin join(prices, order_book, LESS_EQUAL_THAN, INNER);
...
TEST(asof_join_partitioning_right_filter_min, TestSmallZipfExample) {
    Prices prices = load_prices("../test/data/zipf_small_prices.csv", ',', true);
    OrderBook order_book = load_order_book("../test/data/zipf_small_positions.csv", ',', true);
    PartitioningRightFilterMinASOFJoin join(prices, order_book, LESS_EQUAL_THAN, INNER);
...
TEST(asof_join_partitioning_right_filter_min, TestSmallFilterinExample) {
    Prices prices = load_prices("../test/data/small_filter_min_prices_right.csv", ',');
    OrderBook order_book = load_order_book("../test/data/small_filter_min_positions_right.csv", ',');
    PartitioningRightFilterMinASOFJoin join(prices, order_book, LESS_EQUAL_THAN, INNER);

    join.join();

    ASSERT_EQ(join.result.size, 6);
    ASSERT_EQ(join.result.value_sum, 3055);
}

TEST(asof_join_partitioning_left_copy, TestSmallDuckDBExample) {
    Prices prices = load_prices("../test/data/prices_small.csv", ',', true);
    OrderBook order_book = load_order_book("../test/data/orderbook_small.csv", ',', true);
    PartitioningLeftCopyLeftASOFJoin join(prices, order_book, LESS_EQUAL_THAN, INNER);
...
TEST(asof_join_partitioning_left_copy, TestSmallBTCExample) {
    Prices prices = load_prices("../test/data/btc_usd_data.csv", ',', true);
    OrderBook order_book = load_order_book("../test/data/btc_orderbook_small.csv", ',', true);
    PartitioningLeftCopyLeftASOFJoin join(prices, order_book, LESS_EQUAL_THAN, INNER);
...
TEST(asof_join_partitioning_left_copy, TestMediumBTCExample) {
    Prices prices = load_prices("../test/data/btc_usd_data.csv", ',', true);
    OrderBook order_book = load_order_book("../test/data/btc_orderbook_medium.csv", ',', true);
    PartitioningLeftCopyLeftASOFJoin join(prices, order_book, LESS_EQUAL_THAN, INNER);
...
TEST(asof_join_partitioning_left_copy, TestSmallUniformExample) {
    Prices prices = load_prices("../test/data/uniform_small_prices.csv", ',', true);
    OrderBook order_book = load_order_book("../test/data/uniform_small_positions.csv", ',', true);
    PartitioningLeftCopyLeftASOFJoin join(prices, order_book, LESS_EQUAL_THAN, INNER);
...
TEST(asof_join_partitioning_left_copy, TestSmallZipfExample) {
    Prices prices = load_prices("../test/data/zipf_small_prices.csv", ',', true);
    OrderBook order_book = load_order_book("../test/data/zipf_small_positions.csv", ',', true);
    PartitioningLeftCopyLeftASOFJoin join(prices, order_book, LESS_EQUAL_THAN, INNER);
